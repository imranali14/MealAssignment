...
import { FaLinkedin, FaAngleDown, FaAngleUp } from 'react-icons/fa'; // Import LinkedIn and collapse icons
...
const App = () => {
  ...
  const handleLinkedInClick = () => {
    window.open('https://pk.linkedin.com/in/imranali92110', '_blank');
  };
  ...
  return (
    <section className="drawer drawer-mobile bg-base-200" data-theme={storedTheme}>
          ...
          <section className="flex flex-col items-center pt-2 mb-4">
            <div className="avatar">
              <div className="w-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                <img
                  src="https://cdn.pixabay.com/photo/2015/08/27/09/49/robot-909146_960_720.jpg"
                  alt="ALi"
                  loading="lazy"
                />
              </div>
            </div>
            <h2 className="mt-3 font-semibold text-xl">Imran</h2>
      ...
      <div className="collapse-title sm:text-xl text-lg font-medium flex items-center" onClick={handleLinkedInClick}>
